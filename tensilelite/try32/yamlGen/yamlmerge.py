...
for problemidx in range(0, problemnum):
	...
	lines = None
	with open("/home/victorwu/hipBLASLt/tensilelite/try32/yamlGen/tunning_BFVF_Round3/tunning_BFVF_Round3_"+str(problemidx)+"/3_LibraryLogic/aldebaran_Cijk_Ailk_Bljk_HHS_BH.yaml","rt") as txtfile:
	...
	prob = prob+result2
	# print(result2)
with open(r'/home/victorwu/hipBLASLt/tensilelite/try32/yamlGen/merge.yaml', 'w') as fp:
    fp.write(''.join(startsection))
with open(r'/home/victorwu/hipBLASLt/tensilelite/try32/yamlGen/merge.yaml', 'a') as fp:
    fp.write(''.join(arg))
with open(r'/home/victorwu/hipBLASLt/tensilelite/try32/yamlGen/merge.yaml', 'a') as fp:
    fp.write(''.join(prob))
with open(r'/home/victorwu/hipBLASLt/tensilelite/try32/yamlGen/merge.yaml', 'a') as fp:
