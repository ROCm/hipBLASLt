...
for problemidx in range(0, problemnum):
	# print(problemidx)
	df = pd.read_csv('/home/victorwu/hipBLASLt/tensilelite/try32/yamlGen/tunning_BFVF_Round3/tunning_BFVF_Round3_'+str(problemidx)+'/2_BenchmarkData/Cijk_Ailk_Bljk_HHS_BH_00_CSVWinner.csv', encoding='gbk')
...
print(dfout)
dfout.to_csv('/home/victorwu/hipBLASLt/tensilelite/try32/yamlGen/chcekRound3.csv', encoding='gbk', index=False)
