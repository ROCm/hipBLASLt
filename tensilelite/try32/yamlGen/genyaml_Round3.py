...
idx=1
df = pd.read_csv(dirpath+'chcekRound2.csv', encoding='gbk')
df1 = pd.read_csv(dirpath+'chcek.csv', encoding='gbk')
# print(list(df))
# print(df['kernelname'])
for problemidx in range(0, problemnum):
  print(problemidx)
  file1 = open(dirpath+"/FP16_NN_MI250X_Round3_"+str(problemidx)+".yaml","w")
  ...
  # if VectorWidth == 'ijk':
  #   VectorWidth = '-1,2,4,8'
  GlobalReadVectorWidthA = get_arg('_GRVWA')
  if GlobalReadVectorWidthA == 'k':
    GlobalReadVectorWidthA = '-1,2,4,8'
  GlobalReadVectorWidthB = get_arg('_GRVWB')
  if GlobalReadVectorWidthB == 'k':
  ...
  #           - [16, 16,16, 1,  1,  4, 4,  4,1 ] #MT256x64?\n\
          ...
          - GlobalReadVectorWidthA: ["+str(GlobalReadVectorWidthA)+"]\n\
          - GlobalReadVectorWidthB: ["+str(GlobalReadVectorWidthB)+"]\n\
