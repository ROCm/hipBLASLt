...
s_mov_b32 s76, 0x8888889L                          // magic number for WGM==15
...
s_mul_i32 s73, s72, 15                             // quotient * non-magic divisor
...
s_mul_i32 s75, 15, s74                             // quotient * non-magic divisor
s_sub_u32 s76, s[sgprNumWorkGroups1], s75          // WorkGroup1=remainder
s_cmp_eq_u32 s76, 0                                // remainder == 0 ?
s_cmov_b32 s76, 15                                 // remainder = WGM if remainder == 0
s_cmp_ge_u32 s72, s74                              // blockId >= numFullBlocks ?
s_cselect_b32 s74, s76, 15
v_cvt_f32_u32 v6, s74                              // s[sgprWorkGroup0] = s73 / s74
v_rcp_iflag_f32 v6, v6                             // s[sgprWorkGroup0] = s73 / s74
v_cvt_f32_u32 v7, s73                              // s[sgprWorkGroup0] = s73 / s74
v_mul_f32 v6, v6, v7                               // s[sgprWorkGroup0] = s73 / s74
v_cvt_u32_f32 v6, v6                               // s[sgprWorkGroup0] = s73 / s74
v_mul_u32_u24 v7, v6, s74                          // s[sgprWorkGroup0] = s73 / s74
v_sub_u32 v7, s73, v7                              // s[sgprWorkGroup0] = s73 / s74
v_cmpx_eq_u32 exec, v7, s74                        // s[sgprWorkGroup0] = s73 / s74
v_add_u32 v6, 1, v6                                // s[sgprWorkGroup0] = s73 / s74
v_mov_b32 v7, 0                                    // s[sgprWorkGroup1] = s73 % s74
s_mov_b64 exec, -1                                 // s[sgprWorkGroup0] = s73 / s74
v_readfirstlane_b32 s[sgprWorkGroup0], v6
v_readfirstlane_b32 s[sgprWorkGroup1], v7
s_mul_i32 s72, s72, 15                             // blockId * WGM
...
s_cbranch_scc0 label_NoBranch_WRBBC7RV1TD8XWDX_0   // Only branch on scc1
...
label_NoBranch_WRBBC7RV1TD8XWDX_0:
s_waitcnt vmcnt(0)                                 // 8wait for global read
...
/* dataAtIterB=0 numReadsIterB=1 skipReadsIterB=0 readsPerIterB=1 */
/* Stores for OptNLL */
label_Summation_End_NLFTZYZNZW8CVE3D_0:
s_setprio 0                                        // optimization store
...
v_add_u32 v2, v3, v2                               // 5. offset in wave: lrOffset = bnOffset + lrKOffset
v_lshrrev_b32 v0, 8, v[vgprSerial]                 // LSU offset: sgid = Serial / subGroup(256)
s_mov_b32 s71, 64                                  // LSU offset: stride = MT0(64) + PAD0(0)
v_mul_lo_u32 v0, s71, v0                           // LSU offset: lsuoffset = sgid*(MT0+PAD)
v_add_lshl_u32 v[vgprLocalReadAddrA], v0, v1, 0x1  // Final Offset: offset = (lro0*VW+lsuoffset)*bpe
/* N/A */
v_lshrrev_b32 v0, 8, v[vgprSerial]                 // LSU offset: sgid = Serial / subGroup(256)
s_mov_b32 s71, 16                                  // LSU offset: stride = MT1(16) + PAD1(0)
v_mul_lo_u32 v0, s71, v0                           // LSU offset: lsuoffset = sgid*(MT1+PAD)
v_add_lshl_u32 v[vgprLocalReadAddrB], v0, v2, 0x1  // Final Offset: offset = (lro1*VW+lsuoffset)*bpe
v_lshrrev_b32 v1, 7, v[vgprLocalReadAddrB]         // Final Offset: padding 16 per block 128
v_lshlrev_b32 v1, 0x5, v1                          // Final Offset: padding 16 per block 128
v_add_u32 v[vgprLocalReadAddrB], v1, v[vgprLocalReadAddrB] // Final Offset: add padding 16 per block 128
...
/* local read inc a */
s_mov_b32 s71, 0x800                               // inc
v_add_co_u32 v[vgprLocalReadAddrA], vcc, s71, v[vgprLocalReadAddrA] // lrA += 2048 (LSU*(MT+PAD)*bpe)

/* local read inc b */
s_mov_b32 s71, 0x20                                // inc
v_add_co_u32 v[vgprLocalReadAddrB], vcc, s71, v[vgprLocalReadAddrB] // lrB += 32 (LSU*bpe)
...
v_lshlrev_b64 v[26:27], s74, v[vgprValuA_X0_I0+0+0+0:vgprValuA_X0_I0+0+0+0+1]
...
v_lshlrev_b64 v[26:27], s74, v[vgprValuB_X0_I0+0+0+0:vgprValuB_X0_I0+0+0+0+1]
...
label_Summation_End_SAHT1JNHCC4H365W_0:
s_setprio 0                                        // optimization store
/* endSummation: add vgpr [0...40) to pool */
// GSUendSummation
