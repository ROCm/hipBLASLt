...
s_cbranch_scc0 label_NoBranch_IV55CIPM5XJCRN8V_0   // Only branch on scc1
...
label_NoBranch_IV55CIPM5XJCRN8V_0:
s_waitcnt vmcnt(0)                                 // 8wait for global read
...
/* dataAtIterB=0 numReadsIterB=1 skipReadsIterB=0 readsPerIterB=1 */
/* Stores for OptNLL */
label_Summation_End_BZE4CTMULOCDZ25B_0:
...
v_add_u32 v2, v0, v2                               // 7. final local read offset: flrOffset = lrOffset + WOffset
v_lshrrev_b32 v0, 8, v[vgprSerial]                 // LSU offset: sgid = Serial / subGroup(256)
s_mov_b32 s64, 32                                  // LSU offset: stride = MT0(32) + PAD0(0)
...
/* N/A */
v_lshrrev_b32 v0, 8, v[vgprSerial]                 // LSU offset: sgid = Serial / subGroup(256)
s_mov_b32 s64, 32                                  // LSU offset: stride = MT1(32) + PAD1(0)
...
/* local read inc a */
s_mov_b32 s64, 0x440                               // inc
v_add_co_u32 v[vgprLocalReadAddrA], vcc, s64, v[vgprLocalReadAddrA] // lrA += 1088 (LSU*(MT+PAD)*bpe)

/* local read inc b */
s_mov_b32 s64, 0x20                                // inc
v_add_co_u32 v[vgprLocalReadAddrB], vcc, s64, v[vgprLocalReadAddrB] // lrB += 32 (LSU*bpe)
...
label_Summation_End_TWB3VV8Q3E12L3H2_0:
/* endSummation: add vgpr [0...38) to pool */
// GSUendSummation
