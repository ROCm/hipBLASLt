...
s_mov_b32 s69, 0x0                                 // STATIC_DIV: divisior=9
s_mul_i32 s68, 0x38e3, s70                         // tmp1 = dividend * magic hi
s_lshl_b64 s[68:69], s[68:69], 0x10                // left shift 16 bits
s_mul_i32 s[sgprWorkGroup1], s70, 0x8e39           // tmp0 = dividend * magic lo
...
s_mul_i32 s68, s[sgprWorkGroup1], 0x9              // quotient*divisor
s_sub_u32 s[sgprGSUSumIdx], s70, s68               // rReg = dividend - quotient*divisor
s_mov_b32 s72, 0x10000001L                         // magic number for WGM==8
s_mul_hi_u32 s69, s[sgprWorkGroup1], s72           // s_magic mul
s_mul_i32 s68, s[sgprWorkGroup1], s72              // s_magic mul
...
s_mul_hi_u32 s71, s[sgprNumWorkGroups1], s72       // s_magic mul
s_mul_i32 s70, s[sgprNumWorkGroups1], s72          // s_magic mul
s_lshr_b64 s[70:71], s[70:71], 31                  // sMagicDiv
s_mul_i32 s71, 8, s70                              // quotient * non-magic divisor
s_sub_u32 s72, s[sgprNumWorkGroups1], s71          // WorkGroup1=remainder
s_cmp_eq_u32 s72, 0                                // remainder == 0 ?
s_cmov_b32 s72, 8                                  // remainder = WGM if remainder == 0
s_cmp_ge_u32 s68, s70                              // blockId >= numFullBlocks ?
s_cselect_b32 s70, s72, 8
v_cvt_f32_u32 v6, s70                              // s[sgprWorkGroup0] = s69 / s70
v_rcp_iflag_f32 v6, v6                             // s[sgprWorkGroup0] = s69 / s70
v_cvt_f32_u32 v7, s69                              // s[sgprWorkGroup0] = s69 / s70
v_mul_f32 v6, v6, v7                               // s[sgprWorkGroup0] = s69 / s70
v_cvt_u32_f32 v6, v6                               // s[sgprWorkGroup0] = s69 / s70
v_mul_u32_u24 v7, v6, s70                          // s[sgprWorkGroup0] = s69 / s70
v_sub_u32 v7, s69, v7                              // s[sgprWorkGroup0] = s69 / s70
v_cmpx_eq_u32 exec, v7, s70                        // s[sgprWorkGroup0] = s69 / s70
v_add_u32 v6, 1, v6                                // s[sgprWorkGroup0] = s69 / s70
v_mov_b32 v7, 0                                    // s[sgprWorkGroup1] = s69 % s70
s_mov_b64 exec, -1                                 // s[sgprWorkGroup0] = s69 / s70
...
buffer_store_dword v[0], v0, s[sgprSrdDd:sgprSrdDd+3], 0 offen offset:4*2 // 
...
s_cbranch_scc0 label_NoBranch_JOTEFPJOHZO189XN_0   // Only branch on scc1
...
label_NoBranch_JOTEFPJOHZO189XN_0:
s_waitcnt vmcnt(0)                                 // 8wait for global read
...
/* dataAtIterB=0 numReadsIterB=1 skipReadsIterB=0 readsPerIterB=1 */
/* Stores for OptNLL */
label_Summation_End_WSSVYUP1EOKSGELH_0:
s_setprio 0                                        // optimization store
...
s_mul_i32 s58, 64, s[sgprWorkGroup0]               // wgp0 * MT0
...
v_add_u32 v2, v3, v2                               // 5. offset in wave: lrOffset = bnOffset + lrKOffset
v_lshrrev_b32 v0, 8, v[vgprSerial]                 // LSU offset: sgid = Serial / subGroup(256)
s_mov_b32 s67, 64                                  // LSU offset: stride = MT0(64) + PAD0(0)
v_mul_lo_u32 v0, s67, v0                           // LSU offset: lsuoffset = sgid*(MT0+PAD)
v_add_lshl_u32 v[vgprLocalReadAddrA], v0, v1, 0x1  // Final Offset: offset = (lro0*VW+lsuoffset)*bpe
/* N/A */
v_lshrrev_b32 v0, 8, v[vgprSerial]                 // LSU offset: sgid = Serial / subGroup(256)
s_mov_b32 s67, 16                                  // LSU offset: stride = MT1(16) + PAD1(0)
...
/* local read inc a */
s_mov_b32 s67, 0x800                               // inc
v_add_co_u32 v[vgprLocalReadAddrA], vcc, s67, v[vgprLocalReadAddrA] // lrA += 2048 (LSU*(MT+PAD)*bpe)

/* local read inc b */
s_mov_b32 s67, 0x20                                // inc
v_add_co_u32 v[vgprLocalReadAddrB], vcc, s67, v[vgprLocalReadAddrB] // lrB += 32 (LSU*bpe)
...
v_cmp_ge_i32 s[68:69], v24, s[sgprLoopCounterL]    // check K index >= Size L
...
v_cmp_lt_i32 s[68:69], v24, 4                      // set partial 0 if distance less than input per thread
...
v_lshlrev_b64 v[26:27], s70, v[vgprValuA_X0_I0+0+0+0:vgprValuA_X0_I0+0+0+0+1]
v_cndmask_b32 v[vgprValuA_X0_I0+0+0+0+0], v[vgprValuA_X0_I0+0+0+0+0], v26, s[68:69]
v_cndmask_b32 v[vgprValuA_X0_I0+0+0+0+1], v[vgprValuA_X0_I0+0+0+0+1], v27, s[68:69]
v_lshlrev_b64 v[26:27], s70, v[vgprValuB_X0_I0+0+0+0:vgprValuB_X0_I0+0+0+0+1]
v_cndmask_b32 v[vgprValuB_X0_I0+0+0+0+0], v[vgprValuB_X0_I0+0+0+0+0], v26, s[68:69]
v_cndmask_b32 v[vgprValuB_X0_I0+0+0+0+1], v[vgprValuB_X0_I0+0+0+0+1], v27, s[68:69]
s_nop 1
v_mfma_f32_16x16x16f16 acc[0:3], v[vgprValuA_X0_I0+0+0+0:vgprValuA_X0_I0+0+0+0+1], v[vgprValuB_X0_I0+0+0+0:vgprValuB_X0_I0+0+0+0+1], acc[0:3] // left value = acc[0+0:3+0]
...
label_Summation_End_PL0Y4S7HRDRZ4ZYI_0:
s_setprio 0                                        // optimization store
/* endSummation: add vgpr [0...40) to pool */
// GSUendSummation
...
s_and_b32 s64, 63, s[sgprSizeI]                    // s64 = s[sgprSizeI] % 64
...
s_mul_i32 s64, 64, s[sgprWorkGroup0]               // wgp0 * MT0
