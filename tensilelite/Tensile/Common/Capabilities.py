...
def initAsmCaps(isaVersion, assemblerPath, isDebug) -> dict:
    ...
    rv["HasExplicitCO"] = _tryAssembler(
        isaVersion, assemblerPath, "v_add_co_u32 v0,vcc,v0,1", isDebug
    )
    rv["HasExplicitNC"] = _tryAssembler(isaVersion, assemblerPath, "v_add_nc_u32 v0,v0,1", isDebug)

    rv["HasDirectToLds"] = _tryAssembler(
        isaVersion,
        assemblerPath,
        "buffer_load_dword v36, s[24:27], s28 offen offset:0 lds",
        isDebug,
    ) or _tryAssembler(
        isaVersion, assemblerPath, "buffer_load_b32 v36, s[24:27], s28 offen offset:0 lds", isDebug
    )
    rv["HasAddLshl"] = _tryAssembler(
        isaVersion, assemblerPath, "v_add_lshl_u32 v47, v36, v34, 0x2", isDebug
    )
    rv["HasLshlOr"] = _tryAssembler(
        isaVersion, assemblerPath, "v_lshl_or_b32 v47, v36, 0x2, v34", isDebug
    )
    rv["HasSMulHi"] = _tryAssembler(
        isaVersion, assemblerPath, "s_mul_hi_u32 s47, s36, s34", isDebug
    )

    rv["HasMFMA_explictB"] = _tryAssembler(
        isaVersion, assemblerPath, "v_mfma_f32_32x32x1_2b_f32 a[0:31], v0, v1, a[0:31]", isDebug
    )
    rv["HasMFMA"] = (
        _tryAssembler(
            isaVersion, assemblerPath, "v_mfma_f32_32x32x2bf16 a[0:31], v32, v33, a[0:31]", isDebug
        )
        or rv["HasMFMA_explictB"]
    )
    rv["HasMFMA_f64"] = _tryAssembler(
        isaVersion,
        assemblerPath,
    ...
    rv["HasWMMA_V1"] = _tryAssembler(
        isaVersion,
        assemblerPath,
        "v_wmma_f32_16x16x16_f16 v[0:3], v[8:15], v[16:23], v[0:3]",
        isDebug,
    )
    rv["HasWMMA_V2"] = _tryAssembler(
        isaVersion,
        assemblerPath,
        "v_wmma_f32_16x16x16_f16 v[0:3], v[8:9], v[16:17], v[0:3]",
        isDebug,
    ...
    rv["v_pk_fma_f16"] = _tryAssembler(
        isaVersion, assemblerPath, "v_pk_fma_f16 v47, v36, v34, v47, op_sel:[0,0,0]", isDebug
    )
    rv["v_pk_fmac_f16"] = _tryAssembler(
        isaVersion, assemblerPath, "v_pk_fma_f16 v47, v36, v34", isDebug
    )

    rv["v_pk_add_f32"] = _tryAssembler(
        isaVersion, assemblerPath, "v_pk_add_f32 v[48:49], v[36:37], v[0:1]", isDebug
    )
    rv["v_pk_mul_f32"] = _tryAssembler(
    ...
    rv["v_mad_mix_f32"] = _tryAssembler(
        isaVersion,
        assemblerPath,
        "v_mad_mix_f32 v47, v36, v34, v47, op_sel:[0,0,0] op_sel_hi:[1,1,0]",
        isDebug,
    )
    rv["v_fma_mix_f32"] = _tryAssembler(
        isaVersion,
        assemblerPath,
    ...
    rv["v_dot2_f32_f16"] = _tryAssembler(
        isaVersion, assemblerPath, "v_dot2_f32_f16 v20, v36, v34, v20", isDebug
    )
    rv["v_dot2c_f32_f16"] = _tryAssembler(
        isaVersion, assemblerPath, "v_dot2c_f32_f16 v47, v36, v34", isDebug
    ) or _tryAssembler(isaVersion, assemblerPath, "v_dot2acc_f32_f16 v47, v36, v34", isDebug)

    rv["v_dot4_i32_i8"] = _tryAssembler(
        isaVersion, assemblerPath, "v_dot4_i32_i8 v47, v36, v34", isDebug
    )
    rv["v_dot4c_i32_i8"] = _tryAssembler(
        isaVersion, assemblerPath, "v_dot4c_i32_i8 v47, v36, v34", isDebug
    )
    rv["VOP3v_dot4_i32_i8"] = _tryAssembler(
        isaVersion, assemblerPath, "v_dot4_i32_i8 v47, v36, v34, v47", isDebug
    )

    rv["v_mac_f32"] = _tryAssembler(isaVersion, assemblerPath, "v_mac_f32 v20, v21, v22", isDebug)
    rv["v_fma_f32"] = _tryAssembler(
        isaVersion, assemblerPath, "v_fma_f32 v20, v21, v22, v23", isDebug
    )
    rv["v_fmac_f32"] = _tryAssembler(isaVersion, assemblerPath, "v_fmac_f32 v20, v21, v22", isDebug)

    rv["v_fma_f64"] = _tryAssembler(
    ...
    rv["HasAtomicAdd"] = _tryAssembler(
        isaVersion, assemblerPath, "buffer_atomic_add_f32 v0, v1, s[0:3], 0 offen offset:0", isDebug
    ) or _tryAssembler(
        isaVersion,
        assemblerPath,
    ...
    rv["HasGLCModifier"] = _tryAssembler(
        isaVersion,
        assemblerPath,
    ...
    rv["HasMUBUFConst"] = _tryAssembler(
        isaVersion, assemblerPath, "buffer_load_dword v40, v36, s[24:27], 1 offen offset:0", isDebug
    ) or _tryAssembler(
        isaVersion, assemblerPath, "buffer_load_b32 v40, v36, s[24:27], 1 offen offset:0", isDebug
    )
    ...
    rv["HasNTModifier"] = _tryAssembler(
        isaVersion,
        assemblerPath,
