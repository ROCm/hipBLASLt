...
idx=1
df = pd.read_csv('/operator/hipBLASLt/tensilelite/try/yamlGen/chcek.csv', encoding='gbk')
# print(list(df))
# print(df['kernelname'])
for problemidx in range(0, problemnum):
  print(problemidx)
  file1 = open("/operator/hipBLASLt/tensilelite/try/yamlGen/FP16_NN_MI250X_testBFVF_Round2_"+str(problemidx)+".yaml","w")
