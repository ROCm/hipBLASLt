...
for problemidx in range(0, problemnum):
	# print(problemidx)
	df = pd.read_csv('/operator/hipBLASLt/tensilelite/try/yamlGen/tunning_BFVF_Round2/tunning_BFVF_Round2_'+str(problemidx)+'/2_BenchmarkData/Cijk_Ailk_Bljk_HHS_BH_00_CSVWinner.csv', encoding='gbk')
...
print(dfout)
dfout.to_csv('/operator/hipBLASLt/tensilelite/try/yamlGen/chcekRound2.csv', encoding='gbk', index=False)
