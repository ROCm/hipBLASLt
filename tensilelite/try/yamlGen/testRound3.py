...
idx=1
df = pd.read_csv('/Victor/hipBLASLt/hipBLASLt/tensilelite/try/yamlGen/chcekRound2.csv', encoding='gbk')
df1 = pd.read_csv('/Victor/hipBLASLt/hipBLASLt/tensilelite/try/yamlGen/chcek.csv', encoding='gbk')
# print(list(df))
# print(df['kernelname'])
for problemidx in range(0, problemnum):
  print(problemidx)
  file1 = open("/Victor/hipBLASLt/hipBLASLt/tensilelite/try/yamlGen/FP16_NN_MI250X_testBFVF_Round3_"+str(problemidx)+".yaml","w")
