...
idx = 1
df = pd.read_csv('/operator/hipBLASLt/tensilelite/try/yamlGen/tunning_BFVF_Round1/tunning_BFVF_Round1_'+str(idx)+'/2_BenchmarkData/Cijk_Ailk_Bljk_HHS_BH_00_CSVWinner.csv', encoding='gbk')
for problemidx in range(0, problemnum):
...
print(dfout)
dfout.to_csv('/operator/hipBLASLt/tensilelite/try/yamlGen/chcek.csv', encoding='gbk', index=False)
