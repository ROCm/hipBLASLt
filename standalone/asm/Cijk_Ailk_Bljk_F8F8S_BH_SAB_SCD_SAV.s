...
.text
.protected Cijk_Ailk_Bljk_F8F8S_BH_SAB_SCD_SAV_MT16x16x32_MI16x16x1_SN_K1_MIWT1_1
.globl Cijk_Ailk_Bljk_F8F8S_BH_SAB_SCD_SAV_MT16x16x32_MI16x16x1_SN_K1_MIWT1_1
.p2align 8
.type Cijk_Ailk_Bljk_F8F8S_BH_SAB_SCD_SAV_MT16x16x32_MI16x16x1_SN_K1_MIWT1_1,@function
.section .rodata,#alloc
.p2align 6
.amdhsa_kernel Cijk_Ailk_Bljk_F8F8S_BH_SAB_SCD_SAV_MT16x16x32_MI16x16x1_SN_K1_MIWT1_1
...
amdhsa.version:
  ...
  - 1
amdhsa.kernels:
  - .name: Cijk_Ailk_Bljk_F8F8S_BH_SAB_SCD_SAV_MT16x16x32_MI16x16x1_SN_K1_MIWT1_1
    .symbol: 'Cijk_Ailk_Bljk_F8F8S_BH_SAB_SCD_SAV_MT16x16x32_MI16x16x1_SN_K1_MIWT1_1.kd'
    .language:                   OpenCL C
    .language_version:
      - 2
      - 0
...
...
.end_amdgpu_metadata
Cijk_Ailk_Bljk_F8F8S_BH_SAB_SCD_SAV_MT16x16x32_MI16x16x1_SN_K1_MIWT1_1:
...
s_cbranch_scc0 label_NoBranch_0DIJAZKJH03L8QCH_0   // Only branch on scc1
...
label_NoBranch_0DIJAZKJH03L8QCH_0:
...
label_Summation_End_5UQNCNDYKWKKPTE3_0:
s_setprio 0                                        // optimization store
...
s_load_dwordx2 s[56:57], s[sgprKernArgAddress:sgprKernArgAddress+1], 0x78
label_GSU_4:
...
v_cmp_lt_u32 s[40:41], v3, v4                      // wgMT < MT
v_cndmask_b32 v3, v4, v3, s[40:41]                 // wgMT = (wgMT < MT) ? wgMT : MT
...
v_cmp_eq_u32 s[40:41], v6, v5                      // wave_id == block_belong_to_wave?
v_cndmask_b32 v3, v4, v3, s[40:41]                 // wgMT = (wgMT < MT) ? wgMT : MT
...
s_mov_b32 s40, 0
v_cmpx_eq_u32 s[40:41], v6, s40                    // is thread in edge glvw region
...
s_mov_b64 s[40:41], 0xFFFFFFFFFFFFFFFF             // to restore all threads active
s_or_saveexec_b64 vcc, s[40:41]                    // all threads active
...
s_lshl_b32 s40, s[sgprStrideD1J], 2                // incToNextRow: Scale by BPE
s_add_u32 s[sgprSrdD+0], s[sgprSrdD+0], s40        // incToNextRow: gra SRD += inc(lower)
...
v_cndmask_b32 v10, v18, v10, s[62:63]              // LDD clip if OOB. offset
/* (d1,vc1,d0,vc0)=(0,1,0,0) */
...
v_cndmask_b32 v12, v18, v12, s[62:63]              // LDD clip if OOB. offset
/* (d1,vc1,d0,vc0)=(0,2,0,0) */
v_add_co_u32 v1, vcc, v1, 1                        // coord1.1: coord1Vgpr += d1*sg1*VW + vc1
...
v_cndmask_b32 v14, v18, v14, s[62:63]              // LDD clip if OOB. offset
/* (d1,vc1,d0,vc0)=(0,3,0,0) */
v_add_co_u32 v1, vcc, v1, 1                        // coord1.1: coord1Vgpr += d1*sg1*VW + vc1
...
v_cndmask_b32 v16, v18, v16, s[62:63]              // LDD clip if OOB. offset
...
buffer_load_dword v13, v12, s[sgprSrdScaleAlphaVec:sgprSrdScaleAlphaVec+3], 0 offen offset:0 // load scaleAlphaVecI
/* (d1,vc1,d0,vc0)=(0,1,0,0) */
/* (d1,vc1,d0,vc0)=(0,2,0,0) */
/* (d1,vc1,d0,vc0)=(0,3,0,0) */
...
v_accvgpr_read_b32 v[vgprValuC+16], acc2           // copy acc to vreg[2]
v_accvgpr_read_b32 v[vgprValuC+17], acc3           // copy acc to vreg[3]
...
s_waitcnt vmcnt(0)                                 // vmcnt(0) = 1 - 1 (scaleAlphaVec) (interleaved)
...
v_cmp_class_f32 s[40:41], v[vgprValuC+14], v7      // Nan and +/- inf
v_med3_f32 v6, v[vgprValuC+14], v8, v9
v_cndmask_b32 v[vgprValuC+14], v6, v[vgprValuC+14], s[40:41]
...
v_cmp_gt_u32 s[sgprAddressScaleAlphaVec:sgprAddressScaleAlphaVec+1], s[sgprSrdScaleAlphaVec+2], 0 //  == 0 ?
v_cndmask_b32 v13, 1.0, v13, s[sgprAddressScaleAlphaVec:sgprAddressScaleAlphaVec+1] // 1. mul 1 if 0
v_mul_f32 v[vgprValuC+15], v13, v[vgprValuC+15]    // *= scaleAlphaVecVMul
v_mul_f32 v[vgprValuC+15], v[vgprValuC+15], s[sgprScaleD] // result *= ScaleD
v_cmp_class_f32 s[40:41], v[vgprValuC+15], v7      // Nan and +/- inf
v_med3_f32 v6, v[vgprValuC+15], v8, v9
v_cndmask_b32 v[vgprValuC+15], v6, v[vgprValuC+15], s[40:41]
v_cvt_pk_fp8_f32 v15, v[vgprValuC+15], v[vgprValuC+15] op_sel:[0,0,0]
s_lshl_b32 s40, s[sgprStrideD1J], 0                // incToNextRow: Scale by BPE
s_add_u32 s[sgprSrdD+0], s[sgprSrdD+0], s40        // incToNextRow: gra SRD += inc(lower)
s_addc_u32 s[sgprSrdD+1], s[sgprSrdD+1], 0         // incToNextRow: gra SRD += inc(upper)
buffer_store_byte v15, v10, s[sgprSrdD:sgprSrdD+3], 0 offen offset:0 // store D
v_cmp_gt_u32 s[sgprAddressScaleAlphaVec:sgprAddressScaleAlphaVec+1], s[sgprSrdScaleAlphaVec+2], 0 //  == 0 ?
v_cndmask_b32 v13, 1.0, v13, s[sgprAddressScaleAlphaVec:sgprAddressScaleAlphaVec+1] // 1. mul 1 if 0
v_mul_f32 v[vgprValuC+16], v13, v[vgprValuC+16]    // *= scaleAlphaVecVMul
v_mul_f32 v[vgprValuC+16], v[vgprValuC+16], s[sgprScaleD] // result *= ScaleD
v_cmp_class_f32 s[40:41], v[vgprValuC+16], v7      // Nan and +/- inf
v_med3_f32 v6, v[vgprValuC+16], v8, v9
v_cndmask_b32 v[vgprValuC+16], v6, v[vgprValuC+16], s[40:41]
v_cvt_pk_fp8_f32 v16, v[vgprValuC+16], v[vgprValuC+16] op_sel:[0,0,0]
s_lshl_b32 s40, s[sgprStrideD1J], 0                // incToNextRow: Scale by BPE
s_add_u32 s[sgprSrdD+0], s[sgprSrdD+0], s40        // incToNextRow: gra SRD += inc(lower)
s_addc_u32 s[sgprSrdD+1], s[sgprSrdD+1], 0         // incToNextRow: gra SRD += inc(upper)
buffer_store_byte v16, v10, s[sgprSrdD:sgprSrdD+3], 0 offen offset:0 // store D
v_cmp_gt_u32 s[sgprAddressScaleAlphaVec:sgprAddressScaleAlphaVec+1], s[sgprSrdScaleAlphaVec+2], 0 //  == 0 ?
v_cndmask_b32 v13, 1.0, v13, s[sgprAddressScaleAlphaVec:sgprAddressScaleAlphaVec+1] // 1. mul 1 if 0
v_mul_f32 v[vgprValuC+17], v13, v[vgprValuC+17]    // *= scaleAlphaVecVMul
v_mul_f32 v[vgprValuC+17], v[vgprValuC+17], s[sgprScaleD] // result *= ScaleD
v_cmp_class_f32 s[40:41], v[vgprValuC+17], v7      // Nan and +/- inf
v_med3_f32 v6, v[vgprValuC+17], v8, v9
v_cndmask_b32 v[vgprValuC+17], v6, v[vgprValuC+17], s[40:41]
...
buffer_load_dword v12, v11, s[sgprSrdScaleAlphaVec:sgprSrdScaleAlphaVec+3], 0 offen offset:0 // load scaleAlphaVecI
v_add_lshl_u32 v10, v3, v0, 0x0                    // scaleToBpe: accumulate d0 lower and *= bpe into Cin addr
v_cndmask_b32 v10, v24, v10, s[62:63]              // LDD clip if OOB. offset
/* (d1,vc1,d0,vc0)=(0,1,0,0) */
v_add_co_u32 v1, vcc, v1, 1                        // coord1.1: coord1Vgpr += d1*sg1*VW + vc1
...
v_cndmask_b32 v14, v24, v14, s[62:63]              // LDD clip if OOB. offset
/* (d1,vc1,d0,vc0)=(0,2,0,0) */
v_add_co_u32 v1, vcc, v1, 1                        // coord1.1: coord1Vgpr += d1*sg1*VW + vc1
...
v_add_lshl_u32 v17, v3, v0, 0x0                    // scaleToBpe: accumulate d0 lower and *= bpe into Cin addr
v_cndmask_b32 v17, v24, v17, s[62:63]              // LDD clip if OOB. offset
/* (d1,vc1,d0,vc0)=(0,3,0,0) */
v_add_co_u32 v1, vcc, v1, 1                        // coord1.1: coord1Vgpr += d1*sg1*VW + vc1
...
v_add_lshl_u32 v20, v3, v0, 0x0                    // scaleToBpe: accumulate d0 lower and *= bpe into Cin addr
v_cndmask_b32 v20, v24, v20, s[62:63]              // LDD clip if OOB. offset
...
s_waitcnt vmcnt(0)                                 // wait for ScaleAlphaVec
...
v_cmp_class_f32 s[58:59], v[vgprValuC+13], v7      // Nan and +/- inf
v_med3_f32 v6, v[vgprValuC+13], v8, v9
v_cndmask_b32 v[vgprValuC+13], v6, v[vgprValuC+13], s[58:59]
...
v_cmp_gt_u32 s[sgprAddressScaleAlphaVec:sgprAddressScaleAlphaVec+1], s[sgprSrdScaleAlphaVec+2], 0 //  == 0 ?
v_cndmask_b32 v12, 1.0, v12, s[sgprAddressScaleAlphaVec:sgprAddressScaleAlphaVec+1] // 1. mul 1 if 0
v_mul_f32 v[vgprValuC+16], v12, v[vgprValuC+16]    // *= scaleAlphaVecVMul
v_mul_f32 v[vgprValuC+16], v[vgprValuC+16], s[sgprScaleD] // result *= ScaleD
v_cmp_class_f32 s[58:59], v[vgprValuC+16], v7      // Nan and +/- inf
v_med3_f32 v6, v[vgprValuC+16], v8, v9
v_cndmask_b32 v[vgprValuC+16], v6, v[vgprValuC+16], s[58:59]
v_cvt_pk_fp8_f32 v16, v[vgprValuC+16], v[vgprValuC+16] op_sel:[0,0,0]
buffer_store_byte v16, v14, s[sgprSrdD:sgprSrdD+3], 0 offen offset:0 // store D
v_cmp_gt_u32 s[sgprAddressScaleAlphaVec:sgprAddressScaleAlphaVec+1], s[sgprSrdScaleAlphaVec+2], 0 //  == 0 ?
v_cndmask_b32 v12, 1.0, v12, s[sgprAddressScaleAlphaVec:sgprAddressScaleAlphaVec+1] // 1. mul 1 if 0
...
v_cmp_class_f32 s[58:59], v[vgprValuC+19], v7      // Nan and +/- inf
v_med3_f32 v6, v[vgprValuC+19], v8, v9
v_cndmask_b32 v[vgprValuC+19], v6, v[vgprValuC+19], s[58:59]
v_cvt_pk_fp8_f32 v19, v[vgprValuC+19], v[vgprValuC+19] op_sel:[0,0,0]
buffer_store_byte v19, v17, s[sgprSrdD:sgprSrdD+3], 0 offen offset:0 // store D
v_cmp_gt_u32 s[sgprAddressScaleAlphaVec:sgprAddressScaleAlphaVec+1], s[sgprSrdScaleAlphaVec+2], 0 //  == 0 ?
v_cndmask_b32 v12, 1.0, v12, s[sgprAddressScaleAlphaVec:sgprAddressScaleAlphaVec+1] // 1. mul 1 if 0
v_mul_f32 v[vgprValuC+23], v12, v[vgprValuC+23]    // *= scaleAlphaVecVMul
v_mul_f32 v[vgprValuC+23], v[vgprValuC+23], s[sgprScaleD] // result *= ScaleD
v_cmp_class_f32 s[58:59], v[vgprValuC+23], v7      // Nan and +/- inf
v_med3_f32 v6, v[vgprValuC+23], v8, v9
v_cndmask_b32 v[vgprValuC+23], v6, v[vgprValuC+23], s[58:59]
v_cvt_pk_fp8_f32 v23, v[vgprValuC+23], v[vgprValuC+23] op_sel:[0,0,0]
buffer_store_byte v23, v20, s[sgprSrdD:sgprSrdD+3], 0 offen offset:0 // store D
s_nop 0                                            // 1 wait state required when next inst writes vgprs held by previous dwordx4 store inst
s_branch label_GW_End_1                            // jump to end
label_GW_Beta_1:
s_and_b32 s40, 15, s[sgprSizeI]                    // s40 = s[sgprSizeI] % 16
...
buffer_load_ubyte_d16 v13, v11, s[sgprSrdC:sgprSrdC+3], 0 offen offset:0 // load C
v_lshlrev_b32 v12, 0x2, v0                         // ScaleAlphaVec address scaled by BPE
buffer_load_dword v14, v12, s[sgprSrdScaleAlphaVec:sgprSrdScaleAlphaVec+3], 0 offen offset:0 // load scaleAlphaVecI
/* (d1,vc1,d0,vc0)=(0,1,0,0) */
s_lshl_b32 s40, s[sgprStrideC1J], 0                // incToNextRow: Scale by BPE
s_add_u32 s[sgprSrdC+0], s[sgprSrdC+0], s40        // incToNextRow: gra SRD += inc(lower)
...
s_add_u32 s[sgprSrdC+0], s[sgprSrdC+0], s40        // incToNextRow: gra SRD += inc(lower)
s_addc_u32 s[sgprSrdC+1], s[sgprSrdC+1], 0         // incToNextRow: gra SRD += inc(upper)
buffer_load_ubyte_d16 v20, v11, s[sgprSrdC:sgprSrdC+3], 0 offen offset:0 // load C
v_add_lshl_u32 v10, v3, v0, 0x0                    // optSingleColVgpr scaleToBpe: sharedAddrVgpr <- cinRowPtr + coord0, scaled by BPE. BSHERE:coord0=0, coord0Vgpr=0
...
s_waitcnt vmcnt(3)                                 // vmcnt(3) = 5 - 1 (beta) - 1 (scaleAlphaVec) (interleaved)
v_cmp_gt_u32 s[sgprAddressScaleAlphaVec:sgprAddressScaleAlphaVec+1], s[sgprSrdScaleAlphaVec+2], 0 //  == 0 ?
...
v_cvt_f32_fp8 v4, v13 src0_sel:BYTE_0
s_nop 0
...
v_cmp_gt_u32 s[sgprAddressScaleAlphaVec:sgprAddressScaleAlphaVec+1], s[sgprSrdScaleAlphaVec+2], 0 //  == 0 ?
v_cndmask_b32 v14, 1.0, v14, s[sgprAddressScaleAlphaVec:sgprAddressScaleAlphaVec+1] // 1. mul 1 if 0
v_mul_f32 v[vgprValuC+17], v14, v[vgprValuC+17]    // *= scaleAlphaVecVMul
...
v_cmp_gt_u32 s[sgprAddressScaleAlphaVec:sgprAddressScaleAlphaVec+1], s[sgprSrdScaleAlphaVec+2], 0 //  == 0 ?
v_cndmask_b32 v14, 1.0, v14, s[sgprAddressScaleAlphaVec:sgprAddressScaleAlphaVec+1] // 1. mul 1 if 0
v_mul_f32 v[vgprValuC+19], v14, v[vgprValuC+19]    // *= scaleAlphaVecVMul
v_cvt_f32_fp8 v4, v18 src0_sel:BYTE_0
s_nop 0
v_fmac_f32 v[vgprValuC+19], v4, s[sgprBeta]        // finalSum = sum*alpha + C*beta
v_mul_f32 v[vgprValuC+19], v[vgprValuC+19], s[sgprScaleD] // result *= ScaleD
v_cmp_class_f32 s[40:41], v[vgprValuC+19], v7      // Nan and +/- inf
v_med3_f32 v6, v[vgprValuC+19], v8, v9
v_cndmask_b32 v[vgprValuC+19], v6, v[vgprValuC+19], s[40:41]
v_cvt_pk_fp8_f32 v19, v[vgprValuC+19], v[vgprValuC+19] op_sel:[0,0,0]
s_lshl_b32 s40, s[sgprStrideD1J], 0                // incToNextRow: Scale by BPE
s_add_u32 s[sgprSrdD+0], s[sgprSrdD+0], s40        // incToNextRow: gra SRD += inc(lower)
s_addc_u32 s[sgprSrdD+1], s[sgprSrdD+1], 0         // incToNextRow: gra SRD += inc(upper)
...
v_cmp_gt_u32 s[sgprAddressScaleAlphaVec:sgprAddressScaleAlphaVec+1], s[sgprSrdScaleAlphaVec+2], 0 //  == 0 ?
v_cndmask_b32 v14, 1.0, v14, s[sgprAddressScaleAlphaVec:sgprAddressScaleAlphaVec+1] // 1. mul 1 if 0
v_mul_f32 v[vgprValuC+21], v14, v[vgprValuC+21]    // *= scaleAlphaVecVMul
...
v_cmp_class_f32 s[40:41], v[vgprValuC+21], v7      // Nan and +/- inf
v_med3_f32 v6, v[vgprValuC+21], v8, v9
v_cndmask_b32 v[vgprValuC+21], v6, v[vgprValuC+21], s[40:41]
v_cvt_pk_fp8_f32 v21, v[vgprValuC+21], v[vgprValuC+21] op_sel:[0,0,0]
s_lshl_b32 s40, s[sgprStrideD1J], 0                // incToNextRow: Scale by BPE
s_add_u32 s[sgprSrdD+0], s[sgprSrdD+0], s40        // incToNextRow: gra SRD += inc(lower)
s_addc_u32 s[sgprSrdD+1], s[sgprSrdD+1], 0         // incToNextRow: gra SRD += inc(upper)
buffer_store_byte v21, v10, s[sgprSrdD:sgprSrdD+3], 0 offen offset:0 // store D
s_nop 0                                            // 1 wait state required when next inst writes vgprs held by previous dwordx4 store inst
s_branch label_GW_End_1                            // jump to end
label_GW_B1_E1:
...
v_cndmask_b32 v10, v28, v10, s[62:63]              // LDC clip if OOB. offset
buffer_load_ubyte_d16 v12, v10, s[sgprSrdC:sgprSrdC+3], 0 offen offset:0 // load C
v_lshlrev_b32 v11, 0x2, v0                         // ScaleAlphaVec address scaled by BPE
buffer_load_dword v13, v11, s[sgprSrdScaleAlphaVec:sgprSrdScaleAlphaVec+3], 0 offen offset:0 // load scaleAlphaVecI
v_add_lshl_u32 v10, v3, v0, 0x0                    // scaleToBpe: accumulate d0 lower and *= bpe into Cin addr
v_cndmask_b32 v10, v28, v10, s[62:63]              // LDD clip if OOB. offset
/* (d1,vc1,d0,vc0)=(0,1,0,0) */
v_add_co_u32 v1, vcc, v1, 1                        // coord1.1: coord1Vgpr += d1*sg1*VW + vc1
...
v_cmp_lt_u32 s[62:63], v1, s[sgprSizeJ]            // coord1 < size1
s_and_b64 s[62:63], s[58:59], s[62:63]             // in0 && in1
v_add_lshl_u32 v15, v2, v0, 0x0                    // scaleToBpe: accumulate d0 lower and *= bpe into Cin addr
v_cndmask_b32 v15, v28, v15, s[62:63]              // LDC clip if OOB. offset
buffer_load_ubyte_d16 v17, v15, s[sgprSrdC:sgprSrdC+3], 0 offen offset:0 // load C
v_lshlrev_b32 v16, 0x2, v0                         // ScaleAlphaVec address scaled by BPE
v_add_lshl_u32 v15, v3, v0, 0x0                    // scaleToBpe: accumulate d0 lower and *= bpe into Cin addr
v_cndmask_b32 v15, v28, v15, s[62:63]              // LDD clip if OOB. offset
/* (d1,vc1,d0,vc0)=(0,2,0,0) */
v_add_co_u32 v1, vcc, v1, 1                        // coord1.1: coord1Vgpr += d1*sg1*VW + vc1
...
v_cndmask_b32 v19, v28, v19, s[62:63]              // LDC clip if OOB. offset
buffer_load_ubyte_d16 v21, v19, s[sgprSrdC:sgprSrdC+3], 0 offen offset:0 // load C
...
v_cndmask_b32 v19, v28, v19, s[62:63]              // LDD clip if OOB. offset
/* (d1,vc1,d0,vc0)=(0,3,0,0) */
v_add_co_u32 v1, vcc, v1, 1                        // coord1.1: coord1Vgpr += d1*sg1*VW + vc1
...
v_cmp_lt_u32 s[62:63], v1, s[sgprSizeJ]            // coord1 < size1
s_and_b64 s[62:63], s[58:59], s[62:63]             // in0 && in1
v_add_lshl_u32 v24, v2, v0, 0x0                    // scaleToBpe: accumulate d0 lower and *= bpe into Cin addr
v_cndmask_b32 v24, v28, v24, s[62:63]              // LDC clip if OOB. offset
buffer_load_ubyte_d16 v26, v24, s[sgprSrdC:sgprSrdC+3], 0 offen offset:0 // load C
v_lshlrev_b32 v25, 0x2, v0                         // ScaleAlphaVec address scaled by BPE
v_add_lshl_u32 v24, v3, v0, 0x0                    // scaleToBpe: accumulate d0 lower and *= bpe into Cin addr
v_cndmask_b32 v24, v28, v24, s[62:63]              // LDD clip if OOB. offset
v_accvgpr_read_b32 v[vgprValuC+14], acc0           // copy acc to vreg[0]
...
s_waitcnt vmcnt(0)                                 // wait for Beta, ScaleAlphaVec
...
v_mul_f32 v[vgprValuC+14], v[vgprValuC+14], s[sgprScaleD] // result *= ScaleD
v_cmp_class_f32 s[58:59], v[vgprValuC+14], v7      // Nan and +/- inf
v_med3_f32 v6, v[vgprValuC+14], v8, v9
v_cndmask_b32 v[vgprValuC+14], v6, v[vgprValuC+14], s[58:59]
v_cvt_pk_fp8_f32 v14, v[vgprValuC+14], v[vgprValuC+14] op_sel:[0,0,0]
buffer_store_byte v14, v10, s[sgprSrdD:sgprSrdD+3], 0 offen offset:0 // store D
v_cmp_gt_u32 s[sgprAddressScaleAlphaVec:sgprAddressScaleAlphaVec+1], s[sgprSrdScaleAlphaVec+2], 0 //  == 0 ?
v_cndmask_b32 v13, 1.0, v13, s[sgprAddressScaleAlphaVec:sgprAddressScaleAlphaVec+1] // 1. mul 1 if 0
v_mul_f32 v[vgprValuC+18], v13, v[vgprValuC+18]    // *= scaleAlphaVecVMul
...
v_cmp_class_f32 s[58:59], v[vgprValuC+18], v7      // Nan and +/- inf
v_med3_f32 v6, v[vgprValuC+18], v8, v9
v_cndmask_b32 v[vgprValuC+18], v6, v[vgprValuC+18], s[58:59]
v_cvt_pk_fp8_f32 v18, v[vgprValuC+18], v[vgprValuC+18] op_sel:[0,0,0]
buffer_store_byte v18, v15, s[sgprSrdD:sgprSrdD+3], 0 offen offset:0 // store D
v_cmp_gt_u32 s[sgprAddressScaleAlphaVec:sgprAddressScaleAlphaVec+1], s[sgprSrdScaleAlphaVec+2], 0 //  == 0 ?
v_cndmask_b32 v13, 1.0, v13, s[sgprAddressScaleAlphaVec:sgprAddressScaleAlphaVec+1] // 1. mul 1 if 0
v_mul_f32 v[vgprValuC+23], v13, v[vgprValuC+23]    // *= scaleAlphaVecVMul
v_cvt_f32_fp8 v4, v21 src0_sel:BYTE_0
s_nop 0
...
v_cndmask_b32 v[vgprValuC+23], v6, v[vgprValuC+23], s[58:59]
v_cvt_pk_fp8_f32 v23, v[vgprValuC+23], v[vgprValuC+23] op_sel:[0,0,0]
buffer_store_byte v23, v19, s[sgprSrdD:sgprSrdD+3], 0 offen offset:0 // store D
v_cmp_gt_u32 s[sgprAddressScaleAlphaVec:sgprAddressScaleAlphaVec+1], s[sgprSrdScaleAlphaVec+2], 0 //  == 0 ?
v_cndmask_b32 v13, 1.0, v13, s[sgprAddressScaleAlphaVec:sgprAddressScaleAlphaVec+1] // 1. mul 1 if 0
v_mul_f32 v[vgprValuC+27], v13, v[vgprValuC+27]    // *= scaleAlphaVecVMul
v_cvt_f32_fp8 v4, v26 src0_sel:BYTE_0
s_nop 0
v_fmac_f32 v[vgprValuC+27], v4, s[sgprBeta]        // finalSum = sum*alpha + C*beta
v_mul_f32 v[vgprValuC+27], v[vgprValuC+27], s[sgprScaleD] // result *= ScaleD
v_cmp_class_f32 s[58:59], v[vgprValuC+27], v7      // Nan and +/- inf
v_med3_f32 v6, v[vgprValuC+27], v8, v9
v_cndmask_b32 v[vgprValuC+27], v6, v[vgprValuC+27], s[58:59]
v_cvt_pk_fp8_f32 v27, v[vgprValuC+27], v[vgprValuC+27] op_sel:[0,0,0]
buffer_store_byte v27, v24, s[sgprSrdD:sgprSrdD+3], 0 offen offset:0 // store D
s_nop 0                                            // 1 wait state required when next inst writes vgprs held by previous dwordx4 store inst
s_branch label_GW_End_1                            // jump to end
label_GW_End_1:
label_KernelEnd:
