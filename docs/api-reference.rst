...
In order to use FP16-specific data ordering HIPBLASLT_ORDER_COL16_4R8 in hipblasLtMatmul for gfx94x architecture, here's the valid combinations of transposes and orders of input and output matrices:
